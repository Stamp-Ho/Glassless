...
.detail-card { background-color: white; border: 1px solid var(--color-border); border-radius: var(--radius-airbnb); padding: 40px; }
.detail-badge { display: inline-block; background-color: #FFF0F2; padding: 6px 14px; border-radius: 20px; font-size: 0.9rem; font-weight: 600; margin-bottom: 16px; color: var(--color-airbnb-red); }
